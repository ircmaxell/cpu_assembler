...
class DEC16 extends Instruction {

	public function __construct() {
		parent::__construct("DEC16", 0x51, new Argument\ReadWriteRegister, new Argument\ReadWriteRegister);
	}

	protected function getInternalMicroCode(Flag $flag): array {
		$core = [
			$this->mux(M::PC_O, M::MEM_O, M::INC_W, M::RI_W),
			$this->mux(M::INCDEC_O, M::PC_W, M::RIO_X, M::ALU_DEC, M::ALU_W),
